...
const GRAPHICS_DANGER_SECONDARY = mixHexColors(RED_DANGER, GRAPHICS_GRAY_TARGET, 1 / 4);
const GRAPHICS_DANGER_TERTIARY = mixHexColors(RED_DANGER, GRAPHICS_GRAY_TARGET, 2 / 4);
const GRAPHICS_DANGER_QUATERNARY = mixHexColors(RED_DANGER, GRAPHICS_GRAY_TARGET, 3 / 4);
