...
import type { StockChip, StockChipKind } from "@/app/hooks/stock/useStockFilters";
...
type Props = {
  ...
  onOpenCreate: () => void;
  chips: StockChip[];
  onChipClick: (kind: StockChipKind) => void;
  onClearFilters: () => void;
...
export default function StockToolbar({
  ...
  return (
    <div style={{ ...styles.container, ...(style ?? {}) }}>
      ...
      {chips.length > 0 && (
        <div css={styles.chipsContainer} aria-label="Filtros aplicados" data-testid="stock-active-filters">
