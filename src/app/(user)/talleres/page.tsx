...
export default function TalleresPage() {
  ...
  const activeTallerId =
    selectedTallerId || tallerSeleccionadoId || talleres[0]?.id || "";
  const currentTaller =
    talleres.find((t) => t.id === activeTallerId) ?? talleres[0];
  ...
  return (
    <div style={styles.container}>
      <ScreenHeader
        title="Talleres"
        subtitle="Configurá los datos del taller y el valor por hora de mano de obra."
      />
