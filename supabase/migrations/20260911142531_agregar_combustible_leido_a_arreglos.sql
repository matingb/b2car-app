ALTER TABLE public.arreglos
  ADD COLUMN IF NOT EXISTS combustible_leido integer;

ALTER TABLE public.arreglos
  DROP CONSTRAINT IF EXISTS arreglos_combustible_leido_check;

ALTER TABLE public.arreglos
  ADD CONSTRAINT arreglos_combustible_leido_check
  CHECK (combustible_leido IS NULL OR combustible_leido BETWEEN 0 AND 100);
