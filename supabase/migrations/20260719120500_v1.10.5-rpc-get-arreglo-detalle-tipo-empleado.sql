-- v1.10.5 - rpc_get_arreglo_detalle expone tipo_arreglo_id/empleado_id por
-- linea (tanto en detalles/mano de obra como en asignaciones/repuestos), y el
-- nombre resuelto via join a tipos_arreglo/empleados para no requerir un
-- fetch aparte en el frontend.
