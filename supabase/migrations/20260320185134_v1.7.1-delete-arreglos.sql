...
begin
    ...
    p_operacion_ids := public.obtener_operaciones_por_arreglo_id(p_arreglo_id);

    perform public.rpc_borrar_operaciones_con_stock_lista(
        p_operacion_ids := p_operacion_ids
    );
