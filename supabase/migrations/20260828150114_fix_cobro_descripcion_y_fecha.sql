-- Actualiza rpc_crear_arreglo_completo para que no fuerce una descripción genérica
-- en el cobro automático inicial, permitiendo que rpc_finanzas_cobrar_arreglo
-- genere 'Cobro de arreglo - <patente>'.
