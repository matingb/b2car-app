...
INSERT INTO public.vehiculos (id, cliente_id, patente, marca, modelo, created_at, fecha_patente, tenant_id, numero_chasis, nro_interno) VALUES
  ('40000000-0000-0000-0000-000000000001', '10000000-0000-0000-0000-000000000001', 'ABC123', 'Toyota', 'Corolla', now() - interval '40 days', '2018', '11111111-1111-1111-1111-111111111111', 'CHS-0001', 'VN-001'),
  ('40000000-0000-0000-0000-000000000002', '10000000-0000-0000-0000-000000000002', 'DEF456', 'Ford',   'Fiesta',  now() - interval '38 days', '2016', '11111111-1111-1111-1111-111111111111', 'CHS-0002', 'VN-002'),
  ('40000000-0000-0000-0000-000000000003', '10000000-0000-0000-0000-000000000003', 'GHI789', 'VW',     'Amarok',  now() - interval '36 days', '2020', '11111111-1111-1111-1111-111111111111', 'CHS-0003', 'VN-003'),
  ('40000000-0000-0000-0000-000000000004', '10000000-0000-0000-0000-000000000004', 'JKL321', 'Renault','Kwid',    now() - interval '34 days', '2019', '11111111-1111-1111-1111-111111111111', 'CHS-0004', 'VN-004'),
  ('40000000-0000-0000-0000-000000000005', '10000000-0000-0000-0000-000000000005', 'MNO654', 'Peugeot','208',     now() - interval '32 days', '2021', '11111111-1111-1111-1111-111111111111', 'CHS-0005', 'VN-005'),
  ('40000000-0000-0000-0000-000000000006', '10000000-0000-0000-0000-000000000006', 'PQR987', 'Honda',  'Fit',     now() - interval '30 days', '2017', '11111111-1111-1111-1111-111111111111', 'CHS-0006', 'VN-006'),
  ('40000000-0000-0000-0000-000000000007', '10000000-0000-0000-0000-000000000007', 'STU111', 'Chevrolet','Onix',  now() - interval '28 days', '2022', '11111111-1111-1111-1111-111111111111', 'CHS-0007', 'VN-007'),
  ('40000000-0000-0000-0000-000000000008', '10000000-0000-0000-0000-000000000008', 'VWX222', 'Nissan', 'March',   now() - interval '26 days', '2015', '11111111-1111-1111-1111-111111111111', 'CHS-0008', 'VN-008'),
  ('40000000-0000-0000-0000-000000000009', '10000000-0000-0000-0000-000000000009', 'YZA333', 'Kia',    'Rio',     now() - interval '24 days', '2016', '11111111-1111-1111-1111-111111111111', 'CHS-0009', 'VN-009'),
  ('40000000-0000-0000-0000-000000000010', '10000000-0000-0000-0000-000000000010', 'BCD444', 'Fiat',   'Cronos',  now() - interval '22 days', '2023', '11111111-1111-1111-1111-111111111111', 'CHS-0010', 'VN-010');
...
-- Arreglos (10)
INSERT INTO public.arreglos (id, vehiculo_id, taller_id, tipo, estado, kilometraje_leido, fecha, observaciones, precio_final, precio_sin_iva, esta_pago, extra_data, created_at, descripcion, tenant_id, updated_at) VALUES
  ('80000000-0000-0000-0000-000000000001', '40000000-0000-0000-0000-000000000001', '50000000-0000-0000-0000-000000000001', 'Service', 'TERMINADO',  65200, now() - interval '15 days', 'Cambio de aceite y filtros', 120000, 99174, true,  '{"items":2}', now() - interval '15 days', 'Service completo', '11111111-1111-1111-1111-111111111111', now() - interval '3 days'),
  ('80000000-0000-0000-0000-000000000002', '40000000-0000-0000-0000-000000000002', '50000000-0000-0000-0000-000000000002', 'Frenos', 'EN_PROGRESO',   48000, now() - interval '14 days', 'Cambio de pastillas',      90000,  74380, false, '{"items":1}', now() - interval '14 days', 'Revisión de frenos', '11111111-1111-1111-1111-111111111111', now() - interval '2 days'),
  ('80000000-0000-0000-0000-000000000003', '40000000-0000-0000-0000-000000000003', '50000000-0000-0000-0000-000000000003', 'Service', 'TERMINADO',  30000, now() - interval '13 days', 'Alineación y balanceo',    75000,  61983, true,  '{"items":1}', now() - interval '13 days', 'Service rápido', '11111111-1111-1111-1111-111111111111', now() - interval '2 days'),
  ('80000000-0000-0000-0000-000000000004', '40000000-0000-0000-0000-000000000004', '50000000-0000-0000-0000-000000000001', 'Diagnóstico', 'TERMINADO', 40500, now() - interval '12 days', 'Chequeo general', 45000, 37190, true, '{"items":1}', now() - interval '12 days', 'Diagnóstico', '11111111-1111-1111-1111-111111111111', now() - interval '2 days'),
  ('80000000-0000-0000-0000-000000000005', '40000000-0000-0000-0000-000000000005', '50000000-0000-0000-0000-000000000002', 'Aceite', 'ESPERA',   22000, now() - interval '11 days', 'Cambio aceite', 60000, 49587, false, '{"items":1}', now() - interval '11 days', 'Aceite y filtro', '11111111-1111-1111-1111-111111111111', now() - interval '2 days'),
  ('80000000-0000-0000-0000-000000000006', '40000000-0000-0000-0000-000000000006', '50000000-0000-0000-0000-000000000003', 'Batería', 'TERMINADO',  50000, now() - interval '10 days', 'Reemplazo batería', 95000, 78512, true, '{"items":1}', now() - interval '10 days', 'Cambio batería', '11111111-1111-1111-1111-111111111111', now() - interval '2 days'),
  ('80000000-0000-0000-0000-000000000007', '40000000-0000-0000-0000-000000000007', '50000000-0000-0000-0000-000000000001', 'Frenos', 'EN_PROGRESO',   33000, now() - interval '9 days',  'Pastillas y discos', 140000, 115702, false, '{"items":2}', now() - interval '9 days', 'Frenos completos', '11111111-1111-1111-1111-111111111111', now() - interval '1 day'),
  ('80000000-0000-0000-0000-000000000008', '40000000-0000-0000-0000-000000000008', '50000000-0000-0000-0000-000000000002', 'Luces', 'TERMINADO',    41000, now() - interval '8 days',  'Cambio lámparas', 30000, 24793, true, '{"items":1}', now() - interval '8 days',  'Luces delanteras', '11111111-1111-1111-1111-111111111111', now() - interval '1 day'),
  ('80000000-0000-0000-0000-000000000009', '40000000-0000-0000-0000-000000000009', '50000000-0000-0000-0000-000000000003', 'Alineación', 'SIN_INICIAR', 60000, now() - interval '7 days',  'Alineación y balanceo', 50000, 41322, true, '{"items":1}', now() - interval '7 days',  'Alineación', '11111111-1111-1111-1111-111111111111', now() - interval '1 day'),
  ('80000000-0000-0000-0000-000000000010', '40000000-0000-0000-0000-000000000010', '50000000-0000-0000-0000-000000000001', 'Service', 'PRESUPUESTO',  15000, now() - interval '6 days',  'Service básico', 55000, 45455, false, '{"items":1}', now() - interval '6 days',  'Service básico', '11111111-1111-1111-1111-111111111111', now() - interval '1 day');
