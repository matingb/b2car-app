...
INSERT INTO public.operaciones_lineas (id, operacion_id, producto_id, cantidad, monto_unitario, delta_cantidad, created_at) VALUES
  ('91000000-0000-0000-0000-000000000001', '90000000-0000-0000-0000-000000000001', '60000000-0000-0000-0000-000000000001', 2,  6500, -2,  now() - interval '12 days'),
  ('91000000-0000-0000-0000-000000000002', '90000000-0000-0000-0000-000000000002', '60000000-0000-0000-0000-000000000002', 1,  4200, -1,  now() - interval '11 days'),
  ('91000000-0000-0000-0000-000000000003', '90000000-0000-0000-0000-000000000003', '60000000-0000-0000-0000-000000000003', 1, 52000, -1,  now() - interval '10 days'),
  ('91000000-0000-0000-0000-000000000004', '90000000-0000-0000-0000-000000000004', '60000000-0000-0000-0000-000000000004', 2,  5200, -2,  now() - interval '9 days'),
  ('91000000-0000-0000-0000-000000000005', '90000000-0000-0000-0000-000000000005', '60000000-0000-0000-0000-000000000005', 1,  5200, -1,  now() - interval '8 days'),
  ('91000000-0000-0000-0000-000000000006', '90000000-0000-0000-0000-000000000006', '60000000-0000-0000-0000-000000000006', 1,  9800, -1,  now() - interval '7 days'),
  ('91000000-0000-0000-0000-000000000007', '90000000-0000-0000-0000-000000000007', '60000000-0000-0000-0000-000000000007', 2,  3200, -2,  now() - interval '6 days'),
  ('91000000-0000-0000-0000-000000000008', '90000000-0000-0000-0000-000000000008', '60000000-0000-0000-0000-000000000008', 1,  2100, -1,  now() - interval '5 days'),
  ('91000000-0000-0000-0000-000000000009', '90000000-0000-0000-0000-000000000009', '60000000-0000-0000-0000-000000000009', 1,  4300, -1,  now() - interval '4 days'),
  ('91000000-0000-0000-0000-000000000010', '90000000-0000-0000-0000-000000000010', '60000000-0000-0000-0000-000000000010', 1,  7000, -1,  now() - interval '3 days'),
  ('91000000-0000-0000-0000-000000000011', '90000000-0000-0000-0000-000000000011', '60000000-0000-0000-0000-000000000001', 20, 4200,  20, now() - interval '20 days'),
  ('91000000-0000-0000-0000-000000000012', '90000000-0000-0000-0000-000000000012', '60000000-0000-0000-0000-000000000002', 2,  4200, -2,  now() - interval '2 days');
